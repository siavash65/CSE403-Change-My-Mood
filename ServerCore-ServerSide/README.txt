...
First of all, mood and contents are described by integers from 0 to 3 and the mapping of each are shown below:
    PICTURE=0
    VIDEO=1
    TEXT=2
    MUSIC=3
...
Again, make sure you are doing A POST request instead of a get.
